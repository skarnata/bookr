...
class Contributor(models.Model):
    """A contributor to a book ex: author, editor, co-author"""
    first_names = models.CharField(max_length=50, help_text="The contributor first's names or names")
    last_names = models.CharField(max_length=50, help_text="The contributor's last names or names")
